...
else if Pedersen = eng ; Translate Danish to English
{
    gui_search_title = Danish to English
    gui_search("https://translate.google.com/#da/en/REPLACEME")
}
else if Pedersen = dan ; Translate English to Danish
{
...
{
    gui_destroy()
    Send, mcpeterc@gmail.com
}
else if Pedersen = Peter ; My name
{
    gui_destroy()
    Send, Peter Christensen
}
...
else if Pedersen = hmm ; LaTeX integral
{
    gui_destroy()
    SendRaw, ಠ_ಠ  ; ಠ_ಠ
}
